			...
			<div class="panel-body">
				<form id="form-filter" class="form-horizontal">
					<div class="form-group">
						<label for="nama_desa" class="col-sm-2 control-label">Nama Foto</label>
						<div class="col-sm-4">
		...
		<div class="panel panel-primary">
			<div class="panel-body">
				<div class="col-md-8 col-xs-12">
					<?php 
	        		echo '<h4 class="text-muted"><b>Data Foto Beranda</b></h4>';
	        		?>
	        	</div>
	        	<div class="col-md-2 col-xs-12">
				<?php
					echo '<button class="btn btn-success btn-block" onclick="add_slider()"><i class="glyphicon glyphicon-plus"></i> Tambah</button>';
...
<script type="text/javascript">
	...
	//datatables
		table = $('#table').DataTable({
			...
			"type": "POST",
			"data": function ( data ) {
				data.nama_slider = $('#filter_nama_slider').val();
			}
			},
                ...
                <form action="#" id="form" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="nama_foto" name="nama_foto" placeholder="Nama Foto" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input id="path_foto" name="path_foto" class="form-control" type="file" accept="image/*">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
