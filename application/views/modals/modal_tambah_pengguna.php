<form id="form-tambah-pengguna" class="form-horizontal" method="POST">
  <div class="modal-header">
    ...
    <h3 style="display:block; text-align:center;">Tambah Data Tim</h3>                   
  </div> <!-- modal header -->
    ...
    <div class="form-body well">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          ...
          <select class="form-control select2" name="id_kecamatan" id="id_kecamatan" style="width: 100%" <?php if ($this->session->userdata('id_kecamatan')){ echo "disabled"; } ?> onchange="perbaruiPilihanKelurahan()">
            <option value="">-- Pilih Kecamatan --</option>
            <?php
            foreach ($dataKecamatan as $dtkec) {
            ?>
            <option value="<?php echo $dtkec->id_kec; ?>" <?php if ($dtkec->id_kec == $this->session->userdata('id_kecamatan')){ echo "selected"; } ?>><?php echo $dtkec->nama_kec; ?></option>
            <?php
            }
            ?>
          </select>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          ...
          <select class="form-control select2" name="id_desa" id="id_desa" style="width: 100%" <?php if ($this->session->userdata('id_desa')){ echo "disabled"; } ?>  onchange="perbaruiPilihanRW()">
            <option value="">-- Pilih Kelurahan --</option>
            <?php
            foreach ($dataKelurahan as $dtkel) {
            ?>
            <option value="<?php echo $dtkel->id_desa; ?>" <?php if ($dtkel->id_desa == $this->session->userdata('id_desa')){ echo "selected"; } ?>><?php echo $dtkel->nama_desa; ?></option>
            <?php
            }
            ?>
          </select>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          ...
          <select class="form-control select2" name="id_rw" id="id_rw" style="width: 100%" <?php if ($this->session->userdata('id_rw')){ echo "disabled"; } ?>  onchange="perbaruiPilihanRT()">
            <option value="">-- Pilih RW --</option>
            <?php
            foreach ($dataRW as $dtrw) {
            ?>
            <option value="<?php echo $dtrw->id_rw; ?>" <?php if ($dtrw->id_rw == $this->session->userdata('id_rw')){ echo "selected"; } ?>><?php echo $dtrw->nama_rw; ?></option>
            <?php
            }
            ?>
          </select>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input type="text" id="id_rt" name="id_rt" class="form-control">
          <!-- <select class="form-control select2" name="id_rt" id="id_rt" style="width: 100%">
            <option value="">-- Pilih RT --</option>
            <?php
            // foreach ($dataRT as $dtrt) {
            ?>
            <option value="<?php // echo $dtrt->id_rt; ?>"><?php // echo $dtrt->nama_rt; ?></option>
            <?php
             // }
            ?>
          </select> -->
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input name="username" placeholder="Nama Akun" class="form-control" type="text">
          <span class="help-block"></span>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-10">
          <div class="input-group">
            <input id="password" name="password" placeholder="Kata Sandi" class="form-control" type="password" data-toggle="password">
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input name="first_name" placeholder="Nama Lengkap" class="form-control" type="text">
          <span class="help-block"></span>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-10">
          ...
          <select class="form-control select2" name="id_role" id="id_role" style="width: 100%">
            <?php
             foreach ($dataRole as $dtrol) {
            ?>
            <option value="<?php echo $dtrol->id; ?>"><?php echo $dtrol->name; ?></option>
            <?php
            } 
            ?>
          </select>
      ...
      <div class="form-group">
        ...
        <div class="col-md-10">
          <input name="phone" placeholder="Nomor Telepon" class="form-control" type="text">
          <span class="help-block"></span>
        </div>
      </div>
    </div>
