...
class M_tps extends CI_Model {
	...
	var $table = 'tbl_tps';
	var $column_order = array(null, 'tbl_tps.nama_tps','tbl_wrt.nama_rt','tbl_wrw.nama_rw','tbl_wdesa.nama_desa','tbl_wkecamatan.nama_kec','tbl_wkecamatan.kode', null); //set column field database for datatable orderable
	var $column_search = array('tbl_tps.nama_tps','tbl_wrt.nama_rt','tbl_wrw.nama_rw','tbl_wdesa.nama_desa','tbl_wkecamatan.nama_kec','tbl_wkecamatan.kode'); //set column field database for datatable searchable 
	var $order = array('tbl_tps.id' => 'desc'); // default order 
	...
	{
		$this->db->select('tbl_tps.id, tbl_wrt.nama_rt, tbl_wrw.nama_rw, tbl_wdesa.nama_desa, tbl_wkecamatan.nama_kec, tbl_wkecamatan.kode, tbl_tps.nama_tps');
		
		//table join
		
		$this->db->join('tbl_wkecamatan','tbl_wkecamatan.id_kec=tbl_tps.id_kec', 'left');
		
		$this->db->join('tbl_wdesa','tbl_wdesa.id_desa=tbl_tps.id_desa', 'left');
		
		$this->db->join('tbl_wrw','tbl_wrw.id_rw=tbl_tps.id_rw', 'left');

		$this->db->join('tbl_wrt','tbl_wrt.id_rt=tbl_tps.id_rt', 'left');
		...
		{
			$this->db->like('tbl_tps.id_kec', $this->input->post('id_kec'));
		}
		
		//add custom filter here
		if($this->input->post('id_desa'))
		{
			$this->db->like('tbl_tps.id_desa', $this->input->post('id_desa'));
		}
		
		//add custom filter here
		if($this->input->post('id_rw'))
		{
			$this->db->like('tbl_tps.id_rw', $this->input->post('id_rw'));
		}
		//add custom filter here
		if($this->input->post('id_rt'))
		{
			$this->db->like('tbl_tps.id_rt', $this->input->post('id_rt'));
		}
