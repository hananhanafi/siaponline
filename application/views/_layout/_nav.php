    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown user user-menu">
        ...
        <a href="<?php echo base_url(); ?>assets/#" class="dropdown-toggle" data-toggle="dropdown">
          ...
          <img src="<?php echo base_url(); ?>assets/img/<?php if($this->session->userdata('photo')){echo $this->session->userdata('photo');} else {echo "ico21.png";} ?>" class="user-image" alt="User Image">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="user-footer">
            <div class="pull-left">
              <a href="<?php echo base_url('Profile'); ?>" class="btn btn-default btn-flat">Profil Akun</a>
            </div>
